    ...
    <header className="bg-blue-900 text-white py-6">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <a href="#program" className="hover:text-blue-300 transition-colors">Program</a>
          <a href="#nutrition" className="hover:text-blue-300 transition-colors">Nutritions</a>
    ...
    <section className="bg-blue-900 text-white py-20">
      <div className="container mx-auto flex flex-col md:flex-row items-center text-center md:text-left">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0 animate-fade-in">
          <p className="text-gray-300 text-sm">BIZNING DOKON</p>
        ...
        <div className="md:w-1/2">
          <img
            src="https://thumbs.dreamstime.com/z/hikvision-video-surveillance-company-logo-logo-hikvision-company-samsung-tablet-hangzhou-hikvision-digital-technology-co-ltd-120678005.jpg?ct=jpeg" // Rasmingiz yo‘li
            alt="Hero Image"
